...
inline bool Pushed(binary_signal_state DigitalState)
{
...
struct keyboard_input
{
  union
  {
    binary_signal_state Keys[105];
    struct
    {
      binary_signal_state Key_BACK;
      binary_signal_state Key_TAB;
      binary_signal_state Key_SHIFT;
      binary_signal_state Key_CTRL;
      binary_signal_state Key_CLR;
      binary_signal_state Key_ALT;
      binary_signal_state Key_ENTER;
      binary_signal_state Key_PAUSE;
      binary_signal_state Key_CPSLCK;
      binary_signal_state Key_ESCAPE;
      binary_signal_state Key_SPACE;
      binary_signal_state Key_PGUP;
      binary_signal_state Key_PDWN;
      binary_signal_state Key_END;
      binary_signal_state Key_HOME;
      binary_signal_state Key_LEFT;
      binary_signal_state Key_UP;
      binary_signal_state Key_RIGHT;
      binary_signal_state Key_DOWN;
      binary_signal_state Key_PRTSC;
      binary_signal_state Key_INS;
      binary_signal_state Key_DEL;
      binary_signal_state Key_0;
      binary_signal_state Key_1;
      binary_signal_state Key_2;
      binary_signal_state Key_3;
      binary_signal_state Key_4;
      binary_signal_state Key_5;
      binary_signal_state Key_6;
      binary_signal_state Key_7;
      binary_signal_state Key_8;
      binary_signal_state Key_9;
      binary_signal_state Key_A;
      binary_signal_state Key_B;
      binary_signal_state Key_C;
      binary_signal_state Key_D;
      binary_signal_state Key_E;
      binary_signal_state Key_F;
      binary_signal_state Key_G;
      binary_signal_state Key_H;
      binary_signal_state Key_I;
      binary_signal_state Key_J;
      binary_signal_state Key_K;
      binary_signal_state Key_L;
      binary_signal_state Key_M;
      binary_signal_state Key_N;
      binary_signal_state Key_O;
      binary_signal_state Key_P;
      binary_signal_state Key_Q;
      binary_signal_state Key_R;
      binary_signal_state Key_S;
      binary_signal_state Key_T;
      binary_signal_state Key_U;
      binary_signal_state Key_V;
      binary_signal_state Key_W;
      binary_signal_state Key_X;
      binary_signal_state Key_Y;
      binary_signal_state Key_Z;
      binary_signal_state Key_LWIN;
      binary_signal_state Key_RWIN;
      binary_signal_state Key_NP_0;
      binary_signal_state Key_NP_1;
      binary_signal_state Key_NP_2;
      binary_signal_state Key_NP_3;
      binary_signal_state Key_NP_4;
      binary_signal_state Key_NP_5;
      binary_signal_state Key_NP_6;
      binary_signal_state Key_NP_7;
      binary_signal_state Key_NP_8;
      binary_signal_state Key_NP_9;
      binary_signal_state Key_NP_STAR;
      binary_signal_state Key_NP_PLUS;
      binary_signal_state Key_NP_DASH;
      binary_signal_state Key_NP_DEL;
      binary_signal_state Key_NP_SLASH;
      binary_signal_state Key_F1;
      binary_signal_state Key_F2;
      binary_signal_state Key_F3;
      binary_signal_state Key_F4;
      binary_signal_state Key_F5;
      binary_signal_state Key_F6;
      binary_signal_state Key_F7;
      binary_signal_state Key_F8;
      binary_signal_state Key_F9;
      binary_signal_state Key_F10;
      binary_signal_state Key_F11;
      binary_signal_state Key_F12;
      binary_signal_state Key_NP_NMLK;
      binary_signal_state Key_SCRLK;
      binary_signal_state Key_LSHIFT;
      binary_signal_state Key_RSHIFT;
      binary_signal_state Key_LCTRL;
      binary_signal_state Key_RCTRL;
      binary_signal_state Key_COLON;
      binary_signal_state Key_EQUAL;
      binary_signal_state Key_COMMA;
      binary_signal_state Key_DASH;
      binary_signal_state Key_DOT;
      binary_signal_state Key_FSLASH;
      binary_signal_state Key_TILDE;
      binary_signal_state Key_LBRACKET;
      binary_signal_state Key_RBSLASH;
      binary_signal_state Key_RBRACKET;
      binary_signal_state Key_QUOTE;
      binary_signal_state Key_LBSLASH;
    };
  };
};
...
struct game_controller_input
{
  ...
  union
  {
    binary_signal_state Button[24];
    struct
    {
      binary_signal_state DPadUp;
      binary_signal_state DPadDown;
      binary_signal_state DPadLeft;
      binary_signal_state DPadRight;

      binary_signal_state Start;
      binary_signal_state Select;

      binary_signal_state LeftShoulder;
      binary_signal_state RightShoulder;

      binary_signal_state LeftTrigger;
      binary_signal_state RightTrigger;

      binary_signal_state LeftStick;
      binary_signal_state LeftStickUp;
      binary_signal_state LeftStickDown;
      binary_signal_state LeftStickLeft;
      binary_signal_state LeftStickRight;

      binary_signal_state RightStick;
      binary_signal_state RightStickUp;
      binary_signal_state RightStickDown;
      binary_signal_state RightStickLeft;
      binary_signal_state RightStickRight;

      binary_signal_state A;
      binary_signal_state B;
      binary_signal_state X;
      binary_signal_state Y;


      // Note: Fake Button, All new buttons must be added above this one
      binary_signal_state Terminator;
    };
  };
};
